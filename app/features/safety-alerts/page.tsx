...
export default function SOSPage() {
  ...
  return (
    <>
      ...
      <div className={`relative min-h-screen flex items-center justify-center ${isDark ? 'bg-background text-foreground' : 'bg-blue-500/50'} px-4 overflow-hidden`}>
        <div className="backdrop-blur-xl bg-white/30 dark:bg-gray-800/30 rounded-3xl shadow-xl p-10 max-w-md w-full border border-white/50 dark:border-gray-700/50">
